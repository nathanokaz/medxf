...
values (1, '2026-05-2600:00:00.000000', 'admin@gmail.com', 'ADMIN', '$2a$10$qT9ZZD9mpB9hOAYTblyf7eazwsTb0MWgWxbMuN34Umo7S89MyjPre');

insert into admins (id, nome, user_id) 
values (1, 'Cupeludos2', 1);

insert into users (id, criado_em, email, role, senha) 
values (2, '2026-05-2600:00:00.000000', 'medico@gmail.com', 'USER', '$2a$10$qT9ZZD9mpB9hOAYTblyf7eazwsTb0MWgWxbMuN34Umo7S89MyjPre');
