...
public class MedicoService {
    ...
    public void salvarSocioeconomica(CadastroSocioeconomico dados) {
        ...
        socio.setNomeResponsavel(dados.getNomeResponsavel());
        socio.setQuantidadeMoradores(dados.getQuantidadeMoradores());
        socio.setRenda(dados.getRenda());
        socio.setInternet(dados.getInternet());
        socio.setBeneficio(dados.getBeneficio());
        socio.setPlanoSaude(dados.getPlanoSaude());
        socio.setMoradia(dados.getMoradia());
